#ifndef TMBROKEN //APPOINTMENTSFILEMANAGER_H
#define TMBROKEN APPOINTMENTSFILEMANAGER_H
...
class TMBrokenFileManager : public QObject, public BaseFileSystemManager
{
    Q_OBJECT

public:
    // Constructor updated to use ConfigManager pattern per ADR-001
    explicit TMBrokenFileManager(QSettings* settings, QObject* parent = nullptr);
    ~TMBrokenFileManager();
...
#endif // TMBROKEN APPOINTMENTSFILEMANAGER_H
