...
void TMHealthyNetworkDialog::setupUI()
{
    ...
    connect(m_fileList, &QListWidget::itemClicked, this, &TMHealthyNetworkDialog::onFileClicked);
    ...
    connect(m_closeTimer, &QTimer::timeout, this, &TMHealthyNetworkDialog::onTimerTimeout);
...
void TMHealthyNetworkDialog::onFileClicked()
{
    if (!m_fileSelected) {
        m_fileSelected = true;
...
void TMHealthyNetworkDialog::onTimerTimeout()
{
    m_closeButton->setEnabled(true);
}
