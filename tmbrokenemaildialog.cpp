...
TMBrokenEmailDialog::TMBrokenEmailDialog(const QString& networkPath, const QString& jobNumber, QWidget *parent)
    ...
    , m_fileClicked(false)
{
    setWindowTitle("Email Integration - TM BROKEN APPOINTMENTS");
    ...
    Logger::instance().info("TMBrokenEmailDialog created");
}

TMBrokenEmailDialog::~TMBrokenEmailDialog()
{
    Logger::instance().info("TMBrokenEmailDialog destroyed");
}

void TMBrokenEmailDialog::setupUI()
{
    ...
    m_fileList = new TMBrokenEmailFileListWidget(this);
    ...
    // Connect signals
    connect(m_copyPathButton, &QPushButton::clicked, this, &TMBrokenEmailDialog::onCopyPathClicked);
    connect(m_fileList, &QListWidget::itemClicked, this, &TMBrokenEmailDialog::onFileClicked);
    connect(m_closeButton, &QPushButton::clicked, this, &TMBrokenEmailDialog::onCloseClicked);
}

void TMBrokenEmailDialog::populateFileList()
{
...
void TMBrokenEmailDialog::updateCloseButtonState()
{
...
{
    return QDir::cleanPath(MERGED_DIR);
}
...
void TMBrokenEmailDialog::onFileClicked()
{
    m_fileClicked = true;
    updateCloseButtonState();
...
void TMBrokenEmailDialog::onCloseClicked()
{
...
void TMBrokenEmailDialog::closeEvent(QCloseEvent *event)
{
