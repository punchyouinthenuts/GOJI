...
def get_encoding(file_path):
    """
    Determine the encoding based on the file name.
    Returns 'cp1252' for PR files (containing 'PR' or 'APPR' in the base name) to preserve Spanish characters,
    and 'utf-8' for all other files.
    """
