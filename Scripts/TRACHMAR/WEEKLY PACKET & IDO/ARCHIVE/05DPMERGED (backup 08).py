...
text14_recnos = set(df_pcexp[pd.to_numeric(df_pcexp['User Text 3'], errors='coerce') == 14.0]['recno'].values)
...
df_processed_filtered = df_merged[pd.to_numeric(df_merged['User Text 3'], errors='coerce') != 14.0]
