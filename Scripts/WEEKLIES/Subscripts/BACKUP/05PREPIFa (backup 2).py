...
def main():
    ...
    try:
        ...
        df_pr.to_csv(pr_output, index=False, encoding='latin1')
        df_pr_proof = df_pr[:15] if len(df_pr) > 15 else df_pr
        df_pr_proof.to_csv(pr_proof, index=False, encoding='latin1', quoting=csv.QUOTE_NONE, escapechar='\\')
        ...
        df.to_csv(us_output, index=False, encoding='latin1')
        ...
        final_subset.to_csv(us_proof, index=False, encoding='latin1', quoting=csv.QUOTE_NONE, escapechar='\\')
