...
def main():
    ...
    try:
        ...
        df_pr.to_csv(pr_output, index=False, encoding='latin1', float_format='%.0f', quoting=csv.QUOTE_ALL)
        df_pr_proof = df_pr[:15] if len(df_pr) > 15 else df_pr
        df_pr_proof.to_csv(pr_proof, index=False, encoding='latin1', float_format='%.0f', quoting=csv.QUOTE_ALL)
        ...
        df.to_csv(us_output, index=False, encoding='latin1', float_format='%.0f', quoting=csv.QUOTE_ALL)
        ...
        final_subset.to_csv(us_proof, index=False, encoding='latin1', float_format='%.0f', quoting=csv.QUOTE_ALL)
