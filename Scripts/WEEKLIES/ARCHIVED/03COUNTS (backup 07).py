...
def count_versions_in_input(filepath):
    ...
    # Process only CSV files for CBC
    if 'CBC' in filepath:
        ...
        try:
            ...
            # Use exact column name from input files
            ...
            print(f"Error processing CBC input file {filepath}: {str(e)}")
    
    # Keep existing processing for other file types
    else:
        try:
...
def consolidate_counts(counts_dict):
    ...
    for version, count in counts_dict.items():
        ...
        elif version in ['RAC2501-DM05-NCWO1-A', 'RAC2501-DM05-NCWO1-PR']:
            consolidated['NCWO 1-A'] += count
        elif version in ['RAC2501-DM05-NCWO1-AP', 'RAC2501-DM05-NCWO1-APPR']:
            consolidated['NCWO 1-AP'] += count
        elif version in ['RAC2501-DM05-NCWO2-A', 'RAC2501-DM05-NCWO2-PR']:
            consolidated['NCWO 2-A'] += count
        elif version in ['RAC2501-DM05-NCWO2-AP', 'RAC2501-DM05-NCWO2-APPR']:
...
def main():
    ...
    sort_orders = {
        ...
        'NCWO': ['NCWO 1-A PR', 'NCWO 1-A US', 'NCWO 1-AP PR', 'NCWO 1-AP US', 
                 'NCWO 2-A PR', 'NCWO 2-A US', 'NCWO 2-AP PR', 'NCWO 2-AP US'],
