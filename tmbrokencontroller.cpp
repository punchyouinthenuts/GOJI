...
void TMBrokenController::setupOptimizedTableLayout()
{
    ...
    QList<ColumnSpec> columns = {
        {"JOB", "88888", 54},
        {"DESCRIPTION", "TM BROKEN APPOINTMENT", 124},
        {"POSTAGE", "$8,888.8", 29},
        {"COUNT", "88,888", 45},
        {"AVG RATE", "0.88888", 72},
        {"CLASS", "STD", 56},
    ...
    for (int fontSize = 11; fontSize >= 7; fontSize--) {
        ...
        for (const auto& col : columns) {
            int headerWidth = fm.horizontalAdvance(col.header) + 11;
            int contentWidth = fm.horizontalAdvance(col.maxContent) + 11;
    ...
    const int headerFontSize = optimalFontSize - 1;
